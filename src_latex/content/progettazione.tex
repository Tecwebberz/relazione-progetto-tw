...
\begin{itemize}
    \item \textbf{Alessio Ferrarini:}
        \begin{itemize}
            ...
            \item RE
            \item Sviluppo degli script php che si occupano dell' inserimento e rimozione dei dati tramite 
    ...
    \item \textbf{Alessandro Massarenti:}
        \begin{itemize}
            ...
            \item Realizzazione della relazione.
            \item Sviluppo base di dati.
        \end{itemize}
    \item \textbf{Elia Pasquali:}
        \begin{itemize}
            \item Progettazione del sito HTML
            \item Design dell' aspetto grafico del sito.
            \item Sviluppo deJavaScript javascript dedicati alla comparsa/scomparsa di componenti i
            \item Inserimento dei componenti HTML con attributi aria dedicati all' accessibilità.
            \item Realizzazione della realazione.nterattivi. avascript dedicati alla validazione  egli in
            \item Sviluppo base di dati.
        \end{itemize}
t\end{itemize}
